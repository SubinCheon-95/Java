...
public class ObjectTest {
	...
	public static void main(String[] args) {
		...
		// 자바의 모든 클래스는 Object 를 상속하기 때문에 Object 타입으로 업 캐스팅 가능
		Object a1 = new Apple("한국", 3000);
		Object a2 = new Apple("일본", 2000);
		
		// toString() - 객체 정보 조회
		System.out.println(a1.toString());
		System.out.println(a2); // toString()은 default 메서드이기 때문에 객체 이름으로 출력 가능
		...
		System.out.println("a2 해시값 : " + a1.hashCode());
	}
}
